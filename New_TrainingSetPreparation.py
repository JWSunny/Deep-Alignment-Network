...
# @Time    : 2018/5/9 19:18
# @Author  : sunjiawei
# @FileName: New_TrainingSetPreparation.py
...
AllimageDirs = ["../data/images/lfpw/trainset/", "../data/images/helen/trainset/", "../data/images/afw/", "../data/images/menpo/menpo_trainset/"]
datasetDir = "../data/result/"

##  关于meanshape需要重新计算，可以参考实现
...
trainSet.PrepareData(AllimageDirs, None, meanShape, 800, 100000, True)
...
validationSet.PrepareData(imageDirs, boundingBoxFiles, meanShape, 0, 800, False)
validationSet.LoadImages()
validationSet.CropResizeRotateAll()
# import pdb;pdb.set_trace()  ## 在需要单步调试的地方加上面这句，运行程序后中断在此，然后h查看指令进行一步步细细调试
