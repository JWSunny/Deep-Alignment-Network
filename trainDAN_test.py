...
with tf.Session() as sess:
    ...
    if STAGE < 2:
        ...
        tf.train.write_graph(sess.graph_def, "./Model/", "DAN_Menpo_graph.pb", as_text=False)
    else:
        Saver.restore(sess, './Model/DAN-Menpo.ckpt')
    ...
    for epoch in range(150):
        ...
        while Count * 128 < Xtrain.shape[0]:
            ...
            Count += 1
        Saver.save(sess, './Model/DAN-Menpo.ckpt')